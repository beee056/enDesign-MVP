          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <tbody>
                ...
                <tr>
                  <th className="py-4 px-4 bg-slate-50 font-semibold text-slate-900">返品・キャンセル・解約について</th>
                  <td className="py-4 px-4">
                    サービスの性質上、制作着手後および納品後の返品・返金はお受けしておりません。<br/>
                    詳細は利用規約をご確認ください。
                  </td>
                </tr>
              </tbody>
