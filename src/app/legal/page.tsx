...
export const metadata: Metadata = {
  ...
  description: "enDesignの販売条件、公開管理、支払方法、納期、キャンセル等の表示です。",
};
...
const rows = [
  ...
  ["販売価格", "LP制作150,000円（税込）。全契約共通の実績利用同意に加え、社名入り詳細事例、取材および成果確認に追加の包括同意をいただける場合110,000円（税込）。標準範囲は1ページ最大7セクション、オリジナルイラスト1点、合意範囲内の公開前修正1回等です。公開中は月額公開管理契約5,000円（税込）が必須です。追加作業は事前見積りです。"],
  ["商品代金以外の料金", "銀行振込手数料、有料素材、撮影、外部予約・決済・メール等の利用料、個別見積りで明示した第三者費用。"],
  ["支払方法・時期", "銀行振込その他個別契約で定める方法。制作料金は契約時50%、残額は検収完了後7日以内です。月額公開管理料金は初月分を公開開始前、翌月以降を前月末日までに前払いし、開始月・終了月とも日割り計算を行いません。"],
  ...
  ["納品・サービスと権利", "納品とは、確認用または公開用Webサイトへのアクセスを可能にし、完成通知を行うことをいいます。当社名義のドメイン・サーバーと当社管理の制作物を、月額公開管理契約の期間中に利用いただくサービスです。制作物の権利・管理権限は当社に帰属し、ソースコード、編集可能データ、イラスト元データ、テンプレート、プロンプト等は納品・譲渡しません。"],
  ["契約終了時", "30日前までの通知で終了できます。公開管理料金が期限を過ぎた場合は通知のうえ公開を一時停止し、14日以内に解消されない場合は契約・公開・利用許諾を終了できます。ドメインは当社名義で取得・更新する当社の管理資産であり、所有権、登録者名義、移管請求権はお客様に生じません。ドメインおよび制作データの譲渡は行いません。"],
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.body}>
        <p className={styles.lead}>enDesignのWeb制作・公開管理に関する主な販売条件です。案件固有の成果物、金額、納期、権利条件は、個別契約書・仕様書・見積書で確定します。</p>
